        ...
        <div className='flex items-center justify-between py-5 font-medium' >
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    {token && (
                        <div className='hidden group-hover:block absolute right-0 top-5 pt-4 z-20'>
                            <div className='flex flex-col gap-3 w-40 py-4 px-5 bg-slate-100 text-gray-500 rounded'>
            ...
            <div className={`fixed inset-0 z-30 overflow-hidden bg-white transition-all ${visible ? 'w-full pointer-events-auto' : 'w-0 pointer-events-none'} `}>
